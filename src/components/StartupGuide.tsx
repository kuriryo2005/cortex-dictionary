...
const STEPS: Step[] = [
  {
    eyebrow: "はじめに",
    title: "バラバラに覚えるのをやめる",
    lead: "単語を 1 語ずつ暗記するのではなく、語源と意味のつながりで束にして覚えるアプリです。",
    points: [
      "調べた語は意味・語源・ニュアンス・例文まで一度に揃います",
      "保存した語は忘れるころに自動で出題されます",
      "同じ語根の語どうしが図の上で一つの房になります",
    ],
    art: ArtLookup,
  },
  {
    eyebrow: "1. 調べる",
    title: "引くと、周辺ごと手に入る",
    lead: "左上の検索欄に英単語を入れると、AI が意味・文法・語源・ニュアンス・例文・類義語まで組み立てます。",
    points: [
      "「一般」と「学術」を切り替えると、専門文脈での使われ方も出ます",
      "英文を丸ごと貼ると、知らなそうな語だけを抜き出してまとめて追加できます",
      "保存した語はデッキとタグで整理でき、一覧・復習・図のすべてに同じ絞り込みが効きます",
    ],
    art: ArtLookup,
  },
  {
    eyebrow: "2. 覚える",
    title: "今日のサイクル",
    lead: "「今日の学習」に、その日やることが 3 段で並びます。3 段を終えれば今日の分は終わりです。",
    points: [
      "導入 — 今日入れた語に一度目を通す",
      "想起 — 同じ語を、日本語から綴りを打って引き出す",
      "定着 — 期限が来た古い語を混ぜて出す",
    ],
    art: ArtCycle,
  },
  {
    eyebrow: "3. 引き出す",
    title: "見て分かる、と、出てくる、は別もの",
    lead: "カードをめくる復習に加えて、日本語から綴りを打つ想起テストがあります。判定は機械がやるので自己申告の甘さが入りません。",
    points: [
      "評価ボタンには「次にいつ出るか」が出ます（覚えた 10分後 / 余裕 5日後）",
      "新しい語はその日のうちに 1分後・10分後ともう一度出ます",
      "何度やっても抜けない語は自動で拾い上げ、原因を書き出します",
    ],
    art: ArtRecall,
  },
  {
    eyebrow: "4. つなげる",
    title: "単語のつながり",
    lead: "保存した語を、語源・類義語・対義語で結んだ図にします。レイヤーは重ねられます。",
    points: [
      "同じ語根の語は一つの房に集まり、房ごとに色が付きます",
      "語根を選ぶと、まだ持っていない仲間の語を探して追加できます",
      "どこともつながっていない語は別に並べて教えます（いちばん抜けやすい語です）",
    ],
    art: ArtGraph,
  },
  {
    eyebrow: "5. 持ち出す",
    title: "紙にも、他のアプリにも",
    lead: "ためた語は画面の中に閉じ込めません。",
    points: [
      "単語帳は市販の紙面と同じ見開きに組まれ、赤シートと印刷に対応しています",
      "JSON（完全バックアップ）/ CSV / Anki 形式で書き出せます",
      "書き出した JSON からはいつでも復元できます",
    ],
    art: ArtWordbook,
  },
];
